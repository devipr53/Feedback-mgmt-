...
public interface ReportApi {
    ...
    @ApiOperation(value = "report details", nickname = "reportDetails", notes = "Fetch the details for the report", tags={ "EventsAndDashboard", })
    @ApiResponses(value = { 
    ...
    default Flux<ResponseEntity<ViewEvent>> reportDetails() {
